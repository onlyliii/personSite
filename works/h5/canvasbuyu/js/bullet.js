...
function Bullet(type){
	...
	this.imgX = BULLET_SIZE[this.type].x;
	this.imgY = BULLET_SIZE[this.type].y;
	this.x = 444;
	this.y = 570;
	this.rotate = 0;
	this.speed = 5;
...
Bullet.prototype.draw = function(gd){
	...
	gd.drawImage(JSON.bullet, this.imgX, this.imgY, this.w, this.h, -this.w/2, -this.h/2, this.w, this.h);
	gd.restore();
};
